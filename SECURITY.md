...
- `@minions-scaffolds/sdk` (npm package)
- `minions-scaffolds` (PyPI package)
- `@minions-scaffolds/cli` (npm package)
- The minions-scaffolds web playground
- The minions-scaffolds documentation site
