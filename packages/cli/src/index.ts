...
/**
 * @minions-scaffolds/cli — CLI for Minions Scaffolds
 *
...
import { customTypes } from '@minions-scaffolds/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Scaffolds'));
        console.log(chalk.dim('Project scaffolding templates, tech stack configs, and initial file sets'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-scaffolds/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-scaffolds/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-scaffolds')}`);
