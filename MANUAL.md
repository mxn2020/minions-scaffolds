# Manual Setup Steps for Minions Scaffolds
...
Go to **GitHub → mxn2020/minions-scaffolds → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-scaffolds` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-scaffolds-web`
- **GitHub repo**: `mxn2020/minions-scaffolds`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `scaffolds.minions.wtf`

### Documentation
- **Netlify site name**: `minions-scaffolds-docs`
- **GitHub repo**: `mxn2020/minions-scaffolds`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `scaffolds.minions.help`

### Blog
- **Netlify site name**: `minions-scaffolds-blog`
- **GitHub repo**: `mxn2020/minions-scaffolds`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `scaffolds.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `scaffolds.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `scaffolds.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `scaffolds.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-scaffolds/sdk`](https://www.npmjs.com/package/@minions-scaffolds/sdk)
- CLI: [`@minions-scaffolds/cli`](https://www.npmjs.com/package/@minions-scaffolds/cli)
...
Your package: [`minions-scaffolds`](https://pypi.org/project/minions-scaffolds/)
...
| Item | Value |
|------|-------|
| Project | `minions-scaffolds` |
| SDK (npm) | `@minions-scaffolds/sdk` |
| CLI (npm) | `@minions-scaffolds/cli` |
| Python (PyPI) | `minions-scaffolds` |
| GitHub | `github.com/mxn2020/minions-scaffolds` |
| Docs domain | `scaffolds.minions.help` |
| Blog domain | `scaffolds.minions.blog` |
| App domain | `scaffolds.minions.wtf` |
